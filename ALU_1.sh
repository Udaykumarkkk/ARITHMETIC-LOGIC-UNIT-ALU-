...
#
# Script generated by Vivado on Wed Apr 30 13:04:11 +0530 2025
...
#
# Usage        : ALU_1.sh
#                ALU_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ALU_1.sh [-reset_run]
#                ALU_1.sh [-reset_log]
#                ALU_1.sh [-help]
#
...
# script info
echo -e "ALU_1.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ALU_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ALU_1 xil_defaultlib.ALU_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ALU_1 -key {Behavioral:sim_1:Functional:ALU_1} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ALU_1.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ALU_1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ALU_1.sh [-help]\n\
Usage: ALU_1.sh [-step]\n\
Usage: ALU_1.sh [-lib_map_path]\n\
Usage: ALU_1.sh [-reset_run]\n\
Usage: ALU_1.sh [-reset_log]\n\
Usage: ALU_1.sh [-keep_index]\n\
Usage: ALU_1.sh [-noclean_files]\n\n\
