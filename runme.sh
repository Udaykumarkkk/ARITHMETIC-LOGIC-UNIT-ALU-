...
HD_PWD='C:/Users/karan/project_5/project_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU_1.tcl -notrace
